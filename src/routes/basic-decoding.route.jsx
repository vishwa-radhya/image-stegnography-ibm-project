                    ...
                    <div className="space-y-4 sm:space-y-6">
                        ...
                        {currentStep === 1 && (
                            <div className="space-y-4">
                                ...
                                <Button onClick={handleButtonClick} variant={'secondary'} disabled={!file || isDecoding} className="w-full text-sm sm:text-base py-3">
                                    {isDecoding ? (
                                ...
                                {isDecoding && (
                                    <div className="bg-gray-800/30 border border-gray-700/50 rounded-lg p-4">
                                        <div className="text-center">
                                            ...
                                            <p className="text-gray-300 font-medium mb-2 text-sm sm:text-base">Analyzing Image Pixels</p>
                                            <p className="text-gray-500 text-xs sm:text-sm">Extracting hidden data using LSB steganography algorithm...</p>
                                        </div>
                                    </div>
                                )}
                            </div>
