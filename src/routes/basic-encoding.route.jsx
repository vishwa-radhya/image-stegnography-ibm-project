...
const BasicEncoding = () => {
    ...
    return ( 
      <div className="flex flex-col mt-1 gap-10 rounded-lg p-6 shadow-2xl border border-gray-600/30" style={{ backgroundImage: 'linear-gradient(to bottom right, #2b2b2b, #060501, #2b2b2b)' }}>
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-white mb-2 text-center">Basic Steganography Wizard</h2>
        ...
        <div className="mb-8">
              ...
              basicEncodingSteps.map((step,index)=>{
                ...
                return(
                  <div key={`step-ph-${index}`} className="flex items-center">
                    <div className={`
                        flex items-center justify-center  w-[42px] h-10 rounded-full border-2 transition-all duration-300
                    ...
                    {index < basicEncodingSteps.length - 1 && (
                        <div className={`
                            w-13 h-0.5 mx-2 transition-all duration-300
          ...
          <div className="text-center flex flex-col gap-2.5 pt-3.5 pb-5">
              <h3>
                ...
                <div className="space-y-4">
                  <div className="border-2 border-dashed border-gray-600 rounded-lg p-8 text-center hover:border-blue-500 transition-colors">
                      ...
                      <label htmlFor="image-upload" className="cursor-pointer flex flex-col items-center gap-3">
                          ...
                          <p className="text-gray-500 text-sm">Supports JPG, PNG, BMP, and other formats</p>
                      </label>
                  </div>
                  {isProcessing && (
                ...
                <div className="bg-gray-800/30 border border-gray-700/50 rounded-lg p-6">
                    <div className="text-center">
                        {imageData?.isConverted ? (
                            <div className="space-y-4">
                                <svg className="w-12 h-12 text-blue-400 mx-auto animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                                </svg>
                                <div>
                                    <p className="text-gray-300 font-medium mb-2">Converting to BMP format</p>
                                    <p className="text-gray-500 text-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <p className="text-gray-300 font-medium mb-2">Image Ready</p>
                                    <p className="text-gray-500 text-sm">
                    ...
                    <div className="space-y-4">
                        <div className="bg-gray-800/30 border border-gray-700/50 rounded-lg p-6">
                            <div className="text-center space-y-4">
                              <svg className="w-12 h-12 text-[rgb(140,140,140)] mx-auto animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                              </svg>
                              <div>
                                  <p className="text-gray-300 font-medium mb-2">Encoding Secret Message</p>
                                  <p className="text-gray-500 text-sm">
                                      Using LSB (Least Significant Bit) steganography to hide your message in the image pixels.
                                  </p>
                              </div>
                              {isProcessing && (
                ...
                {currentStep === 4 && (
                    <div className="space-y-4">
                        ...
                        <div className="text-center space-y-4">
                            ...
                            <div>
                                <p className="text-green-400 font-medium text-lg mb-2">Encoding Complete!</p>
                                <p className="text-gray-300 text-sm mb-4">
                                    Your secret message has been successfully hidden in the image.
                                    {isProcessing ? ' Preparing download...' : ' Download started automatically.'}
                                </p>
                            </div>
